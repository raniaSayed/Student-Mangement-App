...
<body style="background-color: #808080;">
  ...
  <div class="container-fluid">
    ...
    <div>
     <asp:label CssClass="label label-primary" runat="server"> Enter student data :</asp:label>
        <br />
...
&nbsp; <asp:label CssClass="label label-primary" runat="server"> GPA:</asp:label>&nbsp;&nbsp; :
        <asp:TextBox ID="TextBox3" runat="server" Width="300px" placeholder="Enter GPA" CssClass="form-control"></asp:TextBox>
        <br />
